...
import { EvaluationFormModal } from "./EvaluationFormModal.js";
import { ModernTable } from "@/components/table/Table.js";
import { EvaluationEditModal } from "./EvaluationEditModal.js";
...
export class AdminEvaluationView extends AbstractView {
  constructor(app, { params, route } = {}) {
    ...
    this.formModal = new EvaluationFormModal(app, this.localEvaluations, {
      onSave: async () => {
        this.localEvaluations = await this.controller.loadTeacherEvaluations(this.currentTeacher.id,true);
        this.renderContent();
      },
    });
  }
